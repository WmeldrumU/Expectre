...
// void UIRendererVkNoesis::Draw(VkCommandBuffer commandBuffer, VkImage swapImage) {
// 	if (!mView) {
// 		return;
// 	}
...
// 	// todo: 2 for number of frames in flight. FIX THIS. 
// 	uint64_t safe_frame_number = (frame_num > 2) ? (frame_num - 2) : 0;
// 	SetCommandBuffer(commandBuffer, frame_num, safe_frame_number);
// 	VkCommandBufferBeginInfo beginInfo{};
// 	beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
// 	beginInfo.flags = VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT;

// 	SetRenderTarget(mOnscreenRenderTarget);
// 	SetRenderPass(mRenderPasses[Index(VK_SAMPLE_COUNT_1_BIT)][1], VK_SAMPLE_COUNT_1_BIT);
...
// 	renderpass_info.renderPass = mActiveRenderPass;
// 	RenderTargetVkNs* target = static_cast<RenderTargetVkNs*>(mOnscreenRenderTarget.GetPtr());
// 	renderpass_info.framebuffer = target->framebuffer;
// 	renderpass_info.renderArea.offset.x = 0;
// 	renderpass_info.renderArea.offset.y = 0;
// 	renderpass_info.renderArea.extent.width = 720;
// 	renderpass_info.renderArea.extent.height = 480;
...
// 	//mView->GetRenderer()->UpdateRenderTree();
// 	//SetCommandBuffer(commandBuffer, frame_num, mSafeFrameNumber);
// 	//SetRenderTarget(mRenderTarget);
// 	//SetRenderPass(mActiveRenderPass, VK_SAMPLE_COUNT_1_BIT);
// 	//Tile t;
// 	//t.width = 720;
// 	//t.height = 480;
// 	//t.x = 0;
// 	//t.y = 0;
// 	//BeginTile(mRenderTarget, t);
// 	//mView->GetRenderer()->Render();
// 	//EndTile(mRenderTarget);
// 	//frame_num += 1;

// }

// //void UIRendererVkNoesis::Update(uint64_t total_time) {
// //	mView->Update(total_time);
// //}

// ////////////////////////////////////////////////////////////////////////////////////////////////////
// UIRendererVkNoesis::UIRendererVkNoesis(const RendererInfoVk& info)
// {

// 	NS_ASSERT(info.instance);
// 	NS_ASSERT(info.phys_device);
...
// 	mTransferCommandPool = info.command_pool;
...
// 	SetCommandBuffer(info.command_buffer, 0, 0);
// 	mOnscreenRenderTarget = CreateRenderTarget("test_pass", 720, 480, VK_SAMPLE_COUNT_1_BIT, true);
// 	//mOnscreenRenderTarget
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::SetCommandBuffer(const VkCommandBuffer commandBuffer,
// 	const uint64_t frameNumber, const uint64_t safeFrameNumber)
// {
// 	mCommandBuffer = commandBuffer;
// 	mFrameNumber = frameNumber;
// 	mSafeFrameNumber = safeFrameNumber;

// 	InvalidateStateCache();
// }

// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::SetRenderPass(VkRenderPass renderPass, VkSampleCountFlagBits sampleCount)
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::WarmUpRenderPass(VkRenderPass renderPass, VkSampleCountFlagBits sampleCount)
// {
// 	std::cout << "WarmupRenderPass: " << renderPass << std::endl;
// 	CreatePipelines(renderPass, sampleCount);
// }

// ////////////////////////////////////////////////////////////////////////////////////////////////////
// Ptr<Texture> UIRendererVkNoesis::WrapTexture(VkImage image, uint32_t width, uint32_t height,
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::UpdateLayout(Texture* texture_, VkImageLayout layout)
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void* UIRendererVkNoesis::CreatePixelShader(const char* label, uint8_t shader, const void* spirv,
// 	uint32_t size)
// {
// #ifdef NS_PROFILE
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::ClearPixelShaders()
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::SafeReleaseTexture(Texture* texture_)
// {
// 	VKTexture* texture = (VKTexture*)texture_;
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::SafeReleaseRenderTarget(RenderTarget* surface_)
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::SafeReleaseBuffer(VkBuffer buffer, VkDeviceMemory memory)
// {
// 	PendingDestroy p{};
// 	p.frame = mFrameNumber;
// 	p.buffer = buffer;
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// Ptr<RenderTarget> UIRendererVkNoesis::CreateRenderTarget(const char* label, uint32_t width,
...
// #if !RESOLVE_ON_WRITEBACK
// 	RenderTargetVkNs* surface = (RenderTargetVkNs*)surface_;
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::FillCaps(bool sRGB)
// {
...
// 	if (vkCmdSetDepthTestEnableEXT != nullptr && vkCmdSetStencilTestEnableEXT != nullptr && vkCmdSetStencilOpEXT != nullptr)
// 	{
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::InvalidateStateCache()
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// uint32_t UIRendererVkNoesis::FindMemoryType(uint32_t typeBits, uint32_t required) const
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// uint32_t UIRendererVkNoesis::FindMemoryType(uint32_t typeBits, uint32_t optimal, uint32_t required) const
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// VkFormat UIRendererVkNoesis::FindStencilFormat() const
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// UIRendererVkNoesis::Page* UIRendererVkNoesis::AllocatePage(PageAllocator& allocator)
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// UIRendererVkNoesis::Page* UIRendererVkNoesis::AllocatePage(DynamicBuffer& buffer)
// {
// 	VkBufferCreateInfo bufferInfo{};
// 	bufferInfo.sType = VK_STRUCTURE_TYPE_BUFFER_CREATE_INFO;
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::CreateBuffer(DynamicBuffer& buffer, const char* label, uint32_t size,
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::DestroyBuffer(DynamicBuffer& buffer)
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void* UIRendererVkNoesis::MapBuffer(DynamicBuffer& buffer, uint32_t size)
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::CreateBuffers()
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::DestroyBuffers()
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::DestroyShaders()
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::CreateLayout(uint32_t signature, Layout& layout)
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::CreateLayouts()
// {
// 	for (uint32_t i = 0; i < Shader::Count; i++)
// 	{
// 		const ShaderPS& pShader = ShadersPS(i);
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::DestroyLayouts()
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::CreateTransferCommandPool()
// {
...
// 	V(vkCreateCommandPool(mDevice, &poolInfo, nullptr, &mTransferCommandPool));
// 	VK_NAME(mTransferCommandPool, COMMAND_POOL, "%s", "Noesis_Transfer_CommandPool");
// }

// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::DestroyTransferCommandPool()
// {
// 	vkDestroyCommandPool(mDevice, mTransferCommandPool, nullptr);
// }

// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::CreateDescriptorPool()
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::DestroyDescriptorPool()
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::CreateSamplers()
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::DestroySamplers()
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// VkRenderPass UIRendererVkNoesis::CreateRenderPass(VkSampleCountFlagBits samples, bool needsStencil)
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::DestroyRenderPasses()
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::SetStencilRef(uint32_t stencilRef)
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::SetDepthTestEnable(VkBool32 depthTestEnable)
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::SetStencilTestEnable(VkBool32 stencilTestEnable)
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::SetStencilOp(VkStencilOp passOp, VkCompareOp compareOp)
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::SetStencilMode(StencilMode::Enum stencilMode)
// {
// 	switch (stencilMode)
// 	{
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::BindPipeline(const Batch& batch)
// {

// 	std::cout << "BindPipeline: " << mActiveRenderPass << std::endl;
...
// 	auto pipeline_val = mPipelineMap.Find(hash);
// 	VkPipeline pipeline = mPipelines[pipeline_val->value];
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::SetBuffers(const Batch& batch)
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::UploadUniforms(uint32_t i, const UniformData* data, uint32_t& hash,
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::FillBufferInfo(uint32_t i, const UniformData* data, VkDescriptorSet set,
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::FillImageInfo(Texture* texture, uint8_t sampler, VkDescriptorSet set,
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::TextureHash(uint32_t& hash, Texture* texture_, uint8_t sampler)
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::BindDescriptors(const Batch& batch, const Layout& layout)
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::CreatePipelines(const char* label_, uint8_t shader_, VkRenderPass renderPass,
...
// 	}
// 	int i = mPipelines.Size();
// }

// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::CreatePipelines(const char* label, uint8_t shader, VkRenderPass renderPass,
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::CreatePipelines(VkRenderPass renderPass, VkSampleCountFlagBits sampleCount)
// {
// 	std::cout << "Creating pipeline for renderPass: " << renderPass << " and sample count " << sampleCount << std::endl;
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::DestroyPipelines()
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::ProcessPendingDestroys(bool force)
// {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::EnsureTransferCommands()
// {
// 	if (mTransferCommands == VK_NULL_HANDLE)
// 	{
// 		if (mTransferPoolFrameNumber <= mSafeFrameNumber)
// 		{
// 			V(vkResetCommandPool(mDevice, mTransferCommandPool, 0));
// 		}
...
// 		V(vkAllocateCommandBuffers(mDevice, &allocInfo, &mTransferCommands));

// 		VkCommandBufferBeginInfo beginInfo{};
// 		beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
// 		beginInfo.flags = VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT;

// 		V(vkBeginCommandBuffer(mTransferCommands, &beginInfo));
// 	}
// }

// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::FlushTransferCommands()
// {
// 	if (NS_UNLIKELY(mTransferCommands != VK_NULL_HANDLE))
// 	{
// 		for (Texture* texture : mUpdatedTextures)
// 		{
// 			ChangeLayout(mTransferCommands, texture, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
// 		}

// 		V(vkEndCommandBuffer(mTransferCommands));
// 		mQueueSubmit(mTransferCommands);

// 		//mUpdatedTextures.Clear();
// 		mTransferCommands = nullptr;
// 		mTransferPoolFrameNumber = mFrameNumber;
// 	}
// }

// ////////////////////////////////////////////////////////////////////////////////////////////////////
// void UIRendererVkNoesis::ChangeLayout(VkCommandBuffer commands, Texture* texture_, VkImageLayout layout)
// {
// 	VKTexture* texture = (VKTexture*)texture_;
